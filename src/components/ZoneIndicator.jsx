    ...
    return (
        <div className="fixed right-4 top-1/2 -translate-y-1/2 h-[85vh] flex items-center gap-3 z-[100]">
            ...
            <button
                ...
                className="absolute -left-12 top-0 p-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white z-[110] hover:bg-white/20 transition-colors"
            ...
            {/* Zone List */}
            <div className={`panel p-3 flex flex-col gap-1 w-44 max-h-[80vh] overflow-y-auto transition-all duration-300
                ${isExpanded ? 'opacity-100 translate-x-0 pointer-events-auto' : 'opacity-0 translate-x-10 pointer-events-none'}
                absolute right-12 top-1/2 -translate-y-1/2 z-[105]`}>
