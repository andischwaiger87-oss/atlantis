    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-[60] flex flex-col justify-between p-4 md:p-6">
            ...
            <div className="flex items-start gap-2 w-full">
                <div className="panel px-3 md:px-4 py-2 md:py-3">
                    ...
                    <span className="text-[10px] md:text-xs text-muted">{currentZone?.subtitle}</span>
                </div>

                {/* Mobile: Icon only, Desktop: Icon + Text */}
                <button
                    onClick={() => setIsKnowledgeOpen(true)}
                    className="panel p-2 md:p-3 pointer-events-auto hover:bg-white/10 transition-all group flex items-center gap-2"
