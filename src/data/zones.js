export const ZONES = [
    ...
    // === HORIZONT (0m) ===
    {
        ...
        objects: [
            ...
            { id: 'med-tech-transfer', title: 'Raumfahrt-Medizin Transfer', x: '82%', y: '65%', type: 'info', icon: 'Stethoscope', startYear: 2005, description: 'Technologien für Astronauten helfen Babys: Das "Pulmovista"-System zur Lungenüberwachung bei Frühgeborenen basiert auf medizinischer Forschung für das All.', facts: ['Monitoring ohne Strahlenbelastung', 'Hilfsmittel für die Intensivmedizin', 'Transfer: All -> Kinderklinik'] },
            { id: 'ideas-lab-geo', title: 'IDEAS:lab (Geoinformatik)', x: '24%', y: '35%', type: 'info', icon: 'Map', startYear: 2018, description: 'Ein interaktives Labor der Universität Salzburg, das zeigt, wie Geodaten bei humanitärer Hilfe (z.B. Ärzte ohne Grenzen) und Klimaanpassung helfen.', facts: ['Analysiert Satellitenbilder für Hilfe', 'Unterstützt Flüchtlingslager-Planung', 'Brücke: Wissenschaft -> Praxis'] }
        ]
    },
    // === SONNENLICHTZONE ===
    {
