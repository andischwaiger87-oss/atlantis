export const ZONES = [
    ...
    // === HORIZONT (0m) ===
    {
        ...
        objects: [
            ...
            { id: 'wave-energy', title: 'Wellenkraftwerk', x: '70%', y: '65%', type: 'success', icon: 'Waves', static: true, startYear: 2005, description: 'Nutzt die kinetische Energie der Wellen zur Stromerzeugung.', facts: ['Nachhaltige Ozean-Energie', 'Schutzraum für Fische', 'Konstante Energiequelle'] },
            ...
            { id: 'cargo-tanker', title: 'Industrie-Logistik', x: '95%', y: '65%', type: 'danger', icon: 'Ship', static: true, startYear: 1950, description: '90% des Welthandels verursacht massive Schwefelemissionen.', facts: ['Schweröl-Verbrennung', 'Belastung der Weltmeere', 'Lärmverschmutzung für Wale'] }
        ]
    },
    // === SONNENLICHTZONE ===
    {
